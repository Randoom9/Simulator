...
if (isset($_POST['done'])) {
	if ($_POST['answer'] == "") {
		echo "";
	} else if (trim($_POST['answer']) == '0') {
		header("Location:../third/creativetask.php");
	} else {
		$err = "error";
	}
}
...
<body>
	<img class="face hide" src="../../style/img/nichosi.png" alt="" >
	<img class="pancil hide" src="../../style/img/time_journey.png" alt="" >
	...
	<div class="wrapper">
		...
		<div class="pillar">
			...
			<div class="check ">
				...
				<p><span>Правильный ответ: 3</span></p>
			...
			<div class="example hide">
				...
				<p>P<sub>A</sub><sub>B</sub><sub>C</sub><sub>D</sub> = <form action="" method="post"><input type="text" autocomplete="off" name="answer"><input type="submit" name="done"></form><p style="color: red;"><?php if(isset($err)){echo "Ошибка";}; ?></p></p>
			</div>
			...
			<div class="buttons">
				...
				<button><a href="checkyouself.php">Назад</a></button>
