...
<body>
  ...
  <img class="pancil hide" src="../../style/img/stew.png" alt="" >
  <img class="formula hide" src="../../style/img/love_yourself.png" alt="">
  <style media="screen">
  .face {
    position: absolute;
    z-index: 0;
	...
	<div class="wrapper">
		...
		<div class="pillar">
			...
			<div class="task">
				...
				<p class="hide">«Итак, формула периметра окружности: P = 2πR, где  π=3,14 - математическая постоянная, R – радиус окружности.»</p>
			</div>
			...
			<div class="buttons">
				...
				<button id="go"><a href="perimetr3.php">Далее</a></button>
				<button><a href="perimetr.php">Назад</a></button>
